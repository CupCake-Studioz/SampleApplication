//
//  PasswordMinimumLengthValidation.swift
//  SampleApplication
//
...
class PasswordMinimumLengthValidation: Validation {
    ...
    func validate(input: String?) -> ValidationResult {
        ...
        return ValidationResult(status: false, errorMessage:"Password needs to be at least \(self.minimumLength ?? 5) characters long.")
    }
